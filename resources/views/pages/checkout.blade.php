                    ...
                    <div class="container">
                            ...
                            <div class="col-lg-8 pl-lg-0">
                                ...
                                <div class="attendee">
                                    <table class="table table-responsive-sm text-center">
                                        ...
                                        <tr>
                                            <td>
                                            <!-- <img src="{{url('frontend/images/checkout1.png')}}" height="60"> -->
                        ...
                        <div class="col-lg-4 pr-0">
                            <div class="card card-details card-right"> 
                                ...
                                <div class="bank">
                                    <div class="bank-items pb-3 d-flex flex-wrap align-items-center">
                            ...
                            <div class="join-container">
                                <a href="{{ route('checkout_success', $item->id) }}" class="btn btn-block btn-join-now mt-5 py-2">
                                    I Have Made Payment
                                </a>
                            </div>
