                            ...
                            <div class="card card-details">
                                ...
                                <p>{!! $item->about !!}
                                    ...
                                    <div class="features row">
                                        ...
                                        <div class="col-md-4 border-left">
                                            <div class="description">
                                                <img src="{{url('frontend/images/ic_foods.png')}}" class="featured-image">
                                                <div class="description">
                                                    <h3>Foods</h3>
                                                    <p>{{$item->foods}}</p>
                                                </div>
                    ...
                    <div class="col-lg-4 pr-0">
                        <div class="card card-details card-right">
                            ...
                            <div class="members my-2">
                                ...
                                <img src="{{url('frontend/images/Group 6.png')}}" class="member-image mr-1">
                            </div>
                            <hr>
                        ...
                        @auth
                        <form method="POST" action="{{ route('checkout-process', $item->id) }}">                   
                        @csrf                            
                        ...
                        @guest
                            <a href="{{route('login')}}" 
                                class="btn btn-block btn-join-now mt-5 py-2">
